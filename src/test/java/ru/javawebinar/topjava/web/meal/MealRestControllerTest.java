...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        ...
        assertThrows(NotFoundException.class, () -> mealService.delete(MEAL1_ID, SecurityUtil.authUserId()));
    }
    ...
    void getBetween() throws Exception {
        perform(get(REST_URL + "filter?startDate=" + "2011-01-20T00:00:00" +
                "&endDate=2020-01-30T00:00:00"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON));
        MEAL_MATCHER.assertMatch(mealService.getBetweenInclusive(LocalDate.of(2011,1,20),
                                LocalDate.of(2020,1,30), SecurityUtil.authUserId()), MEAL3, MEAL2, MEAL1);
    }
}